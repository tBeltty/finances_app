...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="bg-surface-container backdrop-blur-xl border-b border-outline sticky top-0 z-40">
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="p-2 text-secondary hover:text-main hover:bg-surface-container rounded-lg transition-colors"
                                title="Ajustes"
                            >
