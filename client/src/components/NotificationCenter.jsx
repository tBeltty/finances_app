...
export default function NotificationCenter() {
    ...
    return (
        <div className="relative z-50" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 md:w-96 bg-[rgb(var(--surface-container)/0.9)] backdrop-blur-3xl rounded-xl shadow-2xl border border-outline/20 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right ring-1 ring-white/10">
